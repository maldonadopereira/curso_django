...
def test_link_de_login_funciona(resp_home):
...
def test_link_de_login_nao_funciona(resp_home_com_usuario_logado):
...
def test_link_de_logout_funciona(resp_home_com_usuario_logado):
